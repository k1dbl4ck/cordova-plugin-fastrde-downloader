...
var Downloader = {
     ...
     * @param {?String} md5
     */
    load: function(url, headers, md5) {
        //console.log("load");
        console.log("loading " + url + " -> ", headers);
        md5 = md5 || null;
    ...
    transferFile: function(fileObject) {
        ...
        Downloader.transfer.download(fileObject.url, filePath, function(entry) {
            ...
            false, { headers: fileObject.headers });
    },
    ...
    interface: {
        obj: null,
            ...
            get: function(url, headers, md5) {
                ...
                return Downloader.load(url, headers, md5);
            },
            /**
